...
<head>
  ...
  <title>Administrator | Penjor Kurir</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg">Penjor Kurir</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="app/update_profil" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y') ?> <a href="#">G2teknologi</a>.</strong> All rights
    reserved.
  </footer>
